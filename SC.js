  ...
  firebase.initializeApp(firebaseConfig);
    ...
    class MEME_CHAT{
      ...
      create_button(){
        ...
        redirect.setAttribute('href', 'chat.html')



        var leave_button = document.createElement('button')
        leave_button.setAttribute('type', "button")
        leave_button.setAttribute('id', 'leave_button')
        leave_button.innerHTML = 'leave <i class="fas fa-sign-out-alt"></i>'

        redirect.append(leave_button)
      ...
      create_footer(){
          ...
          footer_container.setAttribute('id', 'footer_container') 
          footer_container.textContent = ' Version 1.0 - © 2021 Eyad Merajuddin'

          document.body.append(footer_container)
      }
